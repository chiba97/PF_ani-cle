...
このアプリケーションは飼い主がペットと共に歩む人生をより豊かに楽しめるものになるように制作いたしました。他のSNS等でペットアカウントを探す手間を省く為に、ペット関連専門のSNSサイトを考えました。昨今はペットを家族のように迎える方が増えているので、幅広い年代のユーザーが使用できるよう、シンプルで直感的な操作ができるデザインを意識しました。また、様々なデバイスで外出先でも使っていただきたく全ページにレスポンシブ対応を施しました。
